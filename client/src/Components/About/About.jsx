        ...
        <section className={s.team}>
            <div className="container">
                ...
                <h2 className={s.team__subtitle}>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis fugiat voluptatem dolorum sint quia voluptatibus natus minima, a nisi! Quos
                    voluptate harum error fugiat soluta praesentium cupiditate ex perspiciatis ea!
                </h2>
